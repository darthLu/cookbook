...
final List<Recipe> sampleRecipes = [
  ...
  Recipe(
    ...
    description: 'This instant pot ribs recipe is a delicious, tender, and juicy main dish that is perfect for any occasion.',
    cookTime: '1 hr 15 mins',
    ingredients: [
      '1 rack of Pork Ribs',
      '1 teaspoon salt',
    ...
    steps: [
      'Remove white membrane from the back of the ribs',
      'Rub Seasonings all over both sides of the ribs',
      'Place the wire trivet in the bottom of the Instant Pot',
      'Add water, apple cider vinegar, and liquid smoke to the pot.',
      'Place the ribs upright, with the meat side facing out. If you are using one large rack of ribs, then circle them around the pot.',
      'Secure the lid and close vent',
      'Press "manual" or "pressure cook" and set to 25 minutes on high pressure.',
      'When the cooking time is up, allow the pressure to release naturally for 15 minutes, then turn the valve to quick release.'
      'Carefully remove the ribs from the pot and place on a baking sheet. Brush with barbecue sauce.',
      'Optional: Broil for 3-5 minutes until the sauce is caramelized and bubbly.', 
    ],
    category: 'Dinner',
  ),
];
